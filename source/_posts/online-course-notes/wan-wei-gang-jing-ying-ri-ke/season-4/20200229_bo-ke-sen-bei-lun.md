...
Google 是个非常善于使用统计方法的公司，经常弄个“机器学习”之类。大概是2015年，Google 把机器学习用在了自己身上，它想看看从哪些因素能判断一个员工是不是个能干的好员工。Google 经常会招一些各大编程竞赛的获奖者。而机器学习发现，在编程竞赛中得过奖，恰恰是一个说明这个员工工作能力 **不行** 的因素。
